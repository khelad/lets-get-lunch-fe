...
describe('AuthService', () => {
  ...
  describe('signup', () => {
    it('should return a token with a valid username and password', () => {
      ...
      http.expectOne('https://o1x35lxvq684r.educative.run:3000/api/users').flush(signupResponse);
    ...
    it('should return an error for an invalid user object', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/users')
  ...
  describe('login', () => {
    it('should return a token with a valid username and password', () => {
      ...
      http.expectOne('https://o1x35lxvq684r.educative.run:3000/api/sessions').flush(loginResponse);
      expect(response).toEqual(loginResponse);
