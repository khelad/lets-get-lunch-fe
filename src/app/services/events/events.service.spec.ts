...
describe('EventsService', () => {
  ...
  describe('create', () => {
    it('should return an event object with valid event details', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events')
        .flush(eventResponse);
  ...
  describe('getUserEvents', () => {
    it('should return events for a user who is a member of events', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events/user/' + user)
        .flush(eventResponse);
      expect(response).toEqual(eventResponse);
      http.verify();
    });
  ...
  describe('get', () => {
    it('should return an event object with a valid event id', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events/' + eventId)
        .flush(eventResponse);
    ...
    it('should return a 404 for an event id that does not exist', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events/' + '1234')
  ...
  describe('subscribe', () => {
    it('should return an event with an updated members list', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events/' + eventId + '/subscribe')
  ...
  describe('update', () => {
    it('should return an updated event with valid event details', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events/' + updatedEvent._id)
    ...
    it('should return a 500 with invalid event details', () => {
      ...
      http
        .expectOne('https://o1x35lxvq684r.educative.run:3000/api/events/' + event._id)
