  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function vtpD(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login(credentials) {
            ...
            this.authService.login(credentials).subscribe(function (res) {
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 17,
        vars: 3,
        consts: [[1, "container"], [1, "row"], [1, "col-md-4", "col-md-offset-4"], [3, "ngSubmit"], ["form", "ngForm"], [1, "form-group"], ["for", "username"], ["placeholder", "Username", "id", "username", "name", "username", "type", "text", 1, "form-control", 3, "ngModel", "ngModelChange"], ["for", "password"], ["placeholder", "------", "id", "password", "name", "password", "type", "password", 1, "form-control", 3, "ngModel", "ngModelChange"], ["class", "error alert alert-danger", 4, "ngIf"], ["type", "submit", 1, "btn", "btn-default"], [1, "error", "alert", "alert-danger"]],
